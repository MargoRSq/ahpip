    ...
    return [
        c.Div(
            components=[
                ...
                c.Table(data=[result_m]),
                c.Heading(
                    text='Cравнение по конкретным критериям',
                    level=1,
                    class_name='border-bottom pt-3 pb-3',
                ),
                *[
                    c.Div(
                        components=[
                        ...
                        class_name='border-bottom mt-3 pt-3',
                    )
                    for model in comps
                ],
            ],
...
def selector(kind) -> list[AnyComponent]:
    return base_page(
        c.LinkList(
            links=[
                c.Link(
                    components=[c.Text(text='Попарные сравнения')],
                    on_click=PageEvent(
                        name='change-form',
                ...
                c.Link(
                    components=[c.Text(text='Итоговое сравнение')],
                    on_click=PageEvent(
                        name='change-form',
